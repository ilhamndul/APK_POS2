    ...
    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
        <div class="card-body">
            ...
            <div class="text-center mb-4 pb-3 border-bottom">
               <img src="{{ asset('assets/img/logo.png') }}" alt="Logo CV. Jaya Mandiri" class="img-fluid mb-2" style="max-height: 200px; width: auto;">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center pt-3 border-top gap-3">
                ...
                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-sm px-3 rounded-2">
